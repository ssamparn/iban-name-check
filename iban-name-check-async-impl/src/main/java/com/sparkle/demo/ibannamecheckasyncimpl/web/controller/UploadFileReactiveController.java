...
public class UploadFileReactiveController {
    ...
    private Mono<String> saveFile(FilePart filePart) {
        ...
        try {
            ...
            final FileCloseConditionHandler fileCloseConditionHandler = new FileCloseConditionHandler();
            ...
            return filePart.content().doOnEach(dataBufferSignal -> {
                if (dataBufferSignal.hasValue() && !errorFlag.get()) {
                    ...
                    fileCloseConditionHandler.onTaskSubmitted();
                    fileChannel.write(byteBuffer, filePartOffset, null, new CompletionHandler<Integer, ByteBuffer>() {
                        ...
                        public void completed(Integer result, ByteBuffer attachment) {
                            ...
                            if (fileCloseConditionHandler.onTaskCompleted())
                                try {
                                    fileChannel.close();
                ...
                if (fileCloseConditionHandler.canCloseOnComplete())
                    try {
                        fileChannel.close();
                    } catch (IOException ignored) {
                    }
